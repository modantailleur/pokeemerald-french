...
static void CreateStarterPokemonLabel(u8 selection)
{
    ...
    //MT: modified after pokeemerald-multi
    width = GetStringCenterAlignXOffset(FONT_NARROW, speciesName, 0x68);
    AddTextPrinterParameterized3(sStarterLabelWindowId, FONT_NARROW, width, 1, sTextColors, 0, speciesName);

    width = GetStringCenterAlignXOffset(FONT_NORMAL, categoryText, 0x68);
    AddTextPrinterParameterized3(sStarterLabelWindowId, FONT_NORMAL, width, 17, sTextColors, 0, categoryText);
    //
