...
void BufferStringBattle(u16 stringID)
{
    ...
    // MT: defined for use of pokeemerald-multi
    u32 size;
    u8 *txtBuff;
    ...
    *(&gBattleStruct->stringMoveType) = gBattleMsgDataPtr->moveType;
    ...
    // MT: new version taken from pokeemerald multi, to swapt some names
...
// MT: taken from pokeemerald multi --> wild Pokemon -> Pokemon wild
        ...
        if (*src == PLACEHOLDER_BEGIN)
        {
            ...
            case B_TXT_LAST_ITEM: // last used item
                if (gBattleTypeFlags & (BATTLE_TYPE_LINK | BATTLE_TYPE_RECORDED_LINK))
                {
                    ...
                    {
                        // MT: commented after reading pokeemerald multi
                        // if (!(gBattleTypeFlags & BATTLE_TYPE_MULTI))
                        // {
                        ...
                        //         toCpy = sText_EnigmaBerry;
                        // }
                        //MT: added from pokeemerald multi
            ...
            // MT: commented after pokeemerald multi
                // if (gBattleTypeFlags & BATTLE_TYPE_FRONTIER)
