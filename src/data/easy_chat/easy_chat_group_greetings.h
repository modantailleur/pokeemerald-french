...
const u8 gEasyChatWord_Smell[] = _("ODEUR");
const u8 gEasyChatWord_Listening[] = _("ÉCOUTE");
const u8 gEasyChatWord_HooHah[] = _("HOO-HAH");
const u8 gEasyChatWord_Yahoo[] = _("YAHOO");
const u8 gEasyChatWord_Yo[] = _("ILS");
const u8 gEasyChatWord_ComeOver[] = _("VENIR");
const u8 gEasyChatWord_CountOn[] = _("COMPTER SUR");
