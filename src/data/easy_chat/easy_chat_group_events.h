...
const u8 gEasyChatWord_StayAtHome[] = _("RESTE À LA MAISON");
...
const u8 gEasyChatWord_HallOfFame[] = _("TEMPLE DE LA RENOMMÉE");
const u8 gEasyChatWord_Evolution[] = _("ÉVOLUTION");
const u8 gEasyChatWord_Hyper[] = _("HYPER");
const u8 gEasyChatWord_BattleTower[] = _("TOUR DE BATAILLE");
const u8 gEasyChatWord_Leaders[] = _("DIRIGEANTS");
...
const u8 gEasyChatWord_Blend[] = _("MÉLANGE");
const u8 gEasyChatWord_POKEBLOCK[] = _("{POKEBLOC}");
...
const u8 gEasyChatWord_Tower[] = _("LA TOUR");
const u8 gEasyChatWord_Union[] = _("SYNDICAT");
const u8 gEasyChatWord_Room[] = _("CHAMBRE");
