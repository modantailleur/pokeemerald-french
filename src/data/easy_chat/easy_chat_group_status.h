const u8 gEasyChatWord_Dark[] = _("SOMBRE");
const u8 gEasyChatWord_Stench[] = _("PUANTEUR");
const u8 gEasyChatWord_ThickFat[] = _("GRAISSE ÉPAISSE");
const u8 gEasyChatWord_RainDish[] = _("PLAT DE PLUIE");
const u8 gEasyChatWord_Drizzle[] = _("BRUINE");
const u8 gEasyChatWord_ArenaTrap[] = _("PIÈGE D'ARÈNE");
const u8 gEasyChatWord_Intimidate[] = _("INTIMIDER");
const u8 gEasyChatWord_RockHead[] = _("TÊTE DE ROCHE");
const u8 gEasyChatWord_Color[] = _("COULEUR");
const u8 gEasyChatWord_AltColor[] = _("ALTER. COULEUR");
const u8 gEasyChatWord_Rock[] = _("ROCHER");
const u8 gEasyChatWord_Beautiful[] = _("BEAU");
const u8 gEasyChatWord_Beauty[] = _("BEAUTÉ");
const u8 gEasyChatWord_AirLock[] = _("SAS À AIR");
const u8 gEasyChatWord_Psychic[] = _("PSYCHIQUE");
const u8 gEasyChatWord_HyperCutter[] = _("HYPER COUPEUR");
const u8 gEasyChatWord_Fighting[] = _("LUTTE");
const u8 gEasyChatWord_ShadowTag[] = _("ÉTIQUETTE D'OMBRE");
const u8 gEasyChatWord_Smart[] = _("INTELLIGENT");
const u8 gEasyChatWord_Smartness[] = _("ÉLÉGANCE");
const u8 gEasyChatWord_SpeedBoost[] = _("AUGMENTATION DE VITESSE");
const u8 gEasyChatWord_Cool[] = _("COOL");
const u8 gEasyChatWord_Coolness[] = _("FRAÎCHEUR");
const u8 gEasyChatWord_BattleArmor[] = _("ARMURE DE BATAILLE");
const u8 gEasyChatWord_Cute[] = _("MIGNON");
const u8 gEasyChatWord_Cuteness[] = _("MIGNONNERIE");
const u8 gEasyChatWord_Sturdy[] = _("ROBUSTE");
const u8 gEasyChatWord_SuctionCups[] = _("VENTOUSES");
const u8 gEasyChatWord_Grass[] = _("HERBE");
const u8 gEasyChatWord_ClearBody[] = _("CORPS CLAIR");
const u8 gEasyChatWord_Torrent[] = _("TORRENT");
const u8 gEasyChatWord_Ghost[] = _("FANTÔME");
const u8 gEasyChatWord_Ice[] = _("GLACE");
const u8 gEasyChatWord_Guts[] = _("TRIPES");
const u8 gEasyChatWord_RoughSkin[] = _("PEAU RUGUEUSE");
const u8 gEasyChatWord_ShellArmor[] = _("ARMURE DE COQUILLE");
const u8 gEasyChatWord_NaturalCure[] = _("REMÈDE NATURELLE");
const u8 gEasyChatWord_Damp[] = _("HUMIDE");
const u8 gEasyChatWord_Ground[] = _("SOL");
const u8 gEasyChatWord_Limber[] = _("SOUPLE");
const u8 gEasyChatWord_MagnetPull[] = _("TIRAGE AIMANT");
const u8 gEasyChatWord_WhiteSmoke[] = _("FUMÉE BLANCHE");
const u8 gEasyChatWord_Synchronize[] = _("SYNCHRONISER");
const u8 gEasyChatWord_Overgrow[] = _("ENVERSEMENT");
const u8 gEasyChatWord_SwiftSwim[] = _("NAGE RAPIDE");
const u8 gEasyChatWord_SandStream[] = _("COURANT DE SABLE");
const u8 gEasyChatWord_SandVeil[] = _("VOILE DE SABLE");
const u8 gEasyChatWord_KeenEye[] = _("ŒIL VIVANT");
const u8 gEasyChatWord_InnerFocus[] = _("CONCENTRATION INTÉRIEURE");
const u8 gEasyChatWord_Static[] = _("STATIQUE");
const u8 gEasyChatWord_Type[] = _("TAPER");
const u8 gEasyChatWord_Tough[] = _("DIFFICILE");
const u8 gEasyChatWord_Toughness[] = _("DURETÉ");
const u8 gEasyChatWord_ShedSkin[] = _("PEAU MOUTÉE");
const u8 gEasyChatWord_HugePower[] = _("UNE PUISSANCE ÉNORME");
const u8 gEasyChatWord_VoltAbsorb[] = _("A ÉTÉ ABSORBÉ");
const u8 gEasyChatWord_WaterAbsorb[] = _("ABSORBER L'EAU");
const u8 gEasyChatWord_Electric[] = _("ÉLECTRIQUE");
const u8 gEasyChatWord_Forecast[] = _("PRÉVISION");
const u8 gEasyChatWord_SereneGrace[] = _("GRÂCE SEREINE");
const u8 gEasyChatWord_Poison[] = _("POISON");
const u8 gEasyChatWord_PoisonPoint[] = _("POINTE POISON");
const u8 gEasyChatWord_Dragon[] = _("DRAGON");
const u8 gEasyChatWord_Trace[] = _("TRACER");
const u8 gEasyChatWord_Oblivious[] = _("INCONSCIENT");
const u8 gEasyChatWord_Truant[] = _("TRUANT");
const u8 gEasyChatWord_RunAway[] = _("FUYEZ");
const u8 gEasyChatWord_StickyHold[] = _("MAINTIEN COLLANT");
const u8 gEasyChatWord_CloudNine[] = _("NUAGE");
const u8 gEasyChatWord_Normal[] = _("NORMALE");
const u8 gEasyChatWord_Steel[] = _("ACIER");
const u8 gEasyChatWord_Illuminate[] = _("ÉCLAIRER");
const u8 gEasyChatWord_EarlyBird[] = _("LÈVE TÔT");
const u8 gEasyChatWord_Hustle[] = _("AGITATION");
const u8 gEasyChatWord_Shine[] = _("BRILLER");
const u8 gEasyChatWord_Flying[] = _("EN VOLANT");
const u8 gEasyChatWord_Drought[] = _("SÉCHERESSE");
const u8 gEasyChatWord_Lightningrod[] = _("PARATONNERRE");
const u8 gEasyChatWord_Compoundeyes[] = _("YEUX COMPOSÉS");
const u8 gEasyChatWord_MarvelScale[] = _("ÉCHELLE DE MERVEILLE");
const u8 gEasyChatWord_WonderGuard[] = _("GARDE DES MERVEILLES");
const u8 gEasyChatWord_Insomnia[] = _("INSOMNIE");
const u8 gEasyChatWord_Levitate[] = _("LÉVITER");
const u8 gEasyChatWord_Plus[] = _("PLUS");
const u8 gEasyChatWord_Pressure[] = _("PRESSION");
const u8 gEasyChatWord_LiquidOoze[] = _("LIQUIDE LIQUIDE");
const u8 gEasyChatWord_ColorChange[] = _("CHANGEMENT DE COULEUR");
const u8 gEasyChatWord_Soundproof[] = _("INSONORISER");
const u8 gEasyChatWord_EffectSpore[] = _("SPORE D'EFFET");
const u8 gEasyChatWord_Pkrs[] = _("{PK}RS");
const u8 gEasyChatWord_Fire[] = _("FEU");
const u8 gEasyChatWord_FlameBody[] = _("CORPS DE FLAMME");
const u8 gEasyChatWord_Minus[] = _("MOINS");
const u8 gEasyChatWord_OwnTempo[] = _("PROPRE TEMPS");
const u8 gEasyChatWord_MagmaArmor[] = _("ARMURE MAGMA");
const u8 gEasyChatWord_Water[] = _("EAU");
const u8 gEasyChatWord_WaterVeil[] = _("VOILE D'EAU");
const u8 gEasyChatWord_Bug[] = _("BOGUE");
const u8 gEasyChatWord_Swarm[] = _("ESSAIM");
const u8 gEasyChatWord_CuteCharm[] = _("CHARME MIGNON");
const u8 gEasyChatWord_Immunity[] = _("IMMUNITÉ");
const u8 gEasyChatWord_Blaze[] = _("FLAMBER");
const u8 gEasyChatWord_Pickup[] = _("RAMASSER");
const u8 gEasyChatWord_Pattern[] = _("MODÈLE");
const u8 gEasyChatWord_FlashFire[] = _("FEU ÉCLAIR");
const u8 gEasyChatWord_VitalSpirit[] = _("ESPRIT VITAL");
const u8 gEasyChatWord_Chlorophyll[] = _("CHLOROPHYLLE");
const u8 gEasyChatWord_PurePower[] = _("PUISSANCE PURE");
const u8 gEasyChatWord_ShieldDust[] = _("BOUCLIER ANTI-POUSSIÈRE");
