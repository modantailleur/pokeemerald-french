...
const u8 gEasyChatWord_Got[] = _("A OBTENU");
const u8 gEasyChatWord_GoHome[] = _("RENTRER CHEZ SOI");
const u8 gEasyChatWord_Disappointed[] = _("DÉÇU");
const u8 gEasyChatWord_Disappoints[] = _("DÉCEPTION");
...
const u8 gEasyChatWord_Done[] = _("FAIT");
const u8 gEasyChatWord_Danger[] = _("DANGER");
const u8 gEasyChatWord_Defeated[] = _("VAINCU");
const u8 gEasyChatWord_Beat[] = _("BATTRE");
const u8 gEasyChatWord_Great[] = _("SUPER");
