const u8 gEasyChatWord_Hot[] = _("CHAUD");
const u8 gEasyChatWord_Exists[] = _("EXISTE");
const u8 gEasyChatWord_Excess[] = _("EXCÈS");
const u8 gEasyChatWord_Approved[] = _("APPROUVÉ");
const u8 gEasyChatWord_Has[] = _("A");
const u8 gEasyChatWord_Good[] = _("BIEN");
const u8 gEasyChatWord_Less[] = _("MOINS");
const u8 gEasyChatWord_Momentum[] = _("ÉLAN");
const u8 gEasyChatWord_Going[] = _("EN ALLANT");
const u8 gEasyChatWord_Weird[] = _("BIZARRE");
const u8 gEasyChatWord_Busy[] = _("OCCUPÉ");
const u8 gEasyChatWord_Together[] = _("ENSEMBLE");
const u8 gEasyChatWord_Full[] = _("COMPLET");
const u8 gEasyChatWord_Absent[] = _("ABSENT");
const u8 gEasyChatWord_Being[] = _("ÊTRE");
const u8 gEasyChatWord_Need[] = _("BESOIN");
const u8 gEasyChatWord_Tasty[] = _("SAVOUREUX");
const u8 gEasyChatWord_Skilled[] = _("QUALIFIÉ");
const u8 gEasyChatWord_Noisy[] = _("BRUYANT");
const u8 gEasyChatWord_Big[] = _("GRAND");
const u8 gEasyChatWord_Late[] = _("EN RETARD");
const u8 gEasyChatWord_Close[] = _("FERMER");
const u8 gEasyChatWord_Docile[] = _("DOCILE");
const u8 gEasyChatWord_Amusing[] = _("AMUSANT");
const u8 gEasyChatWord_Entertaining[] = _("DIVERTISSANT");
const u8 gEasyChatWord_Perfection[] = _("LA PERFECTION");
const u8 gEasyChatWord_Pretty[] = _("JOLI");
const u8 gEasyChatWord_Healthy[] = _("EN BONNE SANTÉ");
const u8 gEasyChatWord_Excellent[] = _("EXCELLENT");
const u8 gEasyChatWord_UpsideDown[] = _("À L'ENVERS");
const u8 gEasyChatWord_Cold[] = _("FROID");
const u8 gEasyChatWord_Refreshing[] = _("RAFRAÎCHISSANT");
const u8 gEasyChatWord_Unavoidable[] = _("INÉVITABLE");
const u8 gEasyChatWord_Much[] = _("BEAUCOUP");
const u8 gEasyChatWord_Overwhelming[] = _("ACCABLANT");
const u8 gEasyChatWord_Fabulous[] = _("FABULEUX");
const u8 gEasyChatWord_Else[] = _("AUTRE");
const u8 gEasyChatWord_Expensive[] = _("CHER");
...
const u8 gEasyChatWord_Different[] = _("DIFFÉRENT");
const u8 gEasyChatWord_Tired[] = _("FATIGUÉ");
const u8 gEasyChatWord_Skill[] = _("COMPÉTENCE");
const u8 gEasyChatWord_Top[] = _("HAUT");
const u8 gEasyChatWord_NonStop[] = _("NON-STOP");
const u8 gEasyChatWord_Preposterous[] = _("ABSURDE");
const u8 gEasyChatWord_None[] = _("AUCUN");
const u8 gEasyChatWord_Nothing[] = _("RIEN");
const u8 gEasyChatWord_Natural[] = _("NATUREL");
const u8 gEasyChatWord_Becomes[] = _("DEVIENT");
const u8 gEasyChatWord_Lukewarm[] = _("TIÈDE");
const u8 gEasyChatWord_Fast[] = _("RAPIDE");
const u8 gEasyChatWord_Low[] = _("FAIBLE");
const u8 gEasyChatWord_Awful[] = _("AFFREUX");
const u8 gEasyChatWord_Alone[] = _("SEUL");
const u8 gEasyChatWord_Bored[] = _("ENNUYÉ");
const u8 gEasyChatWord_Secret[] = _("SECRÈTE");
const u8 gEasyChatWord_Mystery[] = _("MYSTÈRE");
const u8 gEasyChatWord_Lacks[] = _("MANQUES");
const u8 gEasyChatWord_Best[] = _("MEILLEUR");
const u8 gEasyChatWord_Lousy[] = _("POUILLEUX");
const u8 gEasyChatWord_Mistake[] = _("ERREUR");
const u8 gEasyChatWord_Kind[] = _("GENTIL");
const u8 gEasyChatWord_Well[] = _("BIEN");
const u8 gEasyChatWord_Weakened[] = _("AFFAIBLIE");
const u8 gEasyChatWord_Simple[] = _("SIMPLE");
const u8 gEasyChatWord_Seems[] = _("SEMBLE");
const u8 gEasyChatWord_Badly[] = _("MAL");
