const u8 gEasyChatWord_KthxBye[] = _("KTHX, AU REVOIR.");
const u8 gEasyChatWord_YesSirExcl[] = _("OUI MONSIEUR!");
const u8 gEasyChatWord_AvantGarde[] = _("AVANT GARDE");
const u8 gEasyChatWord_Couple[] = _("COUPLE");
const u8 gEasyChatWord_MuchObliged[] = _("BIEN OBLIGÉ");
const u8 gEasyChatWord_YeehawExcl[] = _("OUAIS !");
const u8 gEasyChatWord_Mega[] = _("MÉGA");
const u8 gEasyChatWord_1HitKOExcl[] = _("1-J'AI FRAPPÉ !");
const u8 gEasyChatWord_Destiny[] = _("DESTIN");
const u8 gEasyChatWord_Cancel[] = _("ANNULER");
const u8 gEasyChatWord_New[] = _("NOUVEAU");
const u8 gEasyChatWord_Flatten[] = _("APLATIR");
const u8 gEasyChatWord_Kidding[] = _("BLAGUE");
const u8 gEasyChatWord_Loser[] = _("PERDANT");
const u8 gEasyChatWord_Losing[] = _("PERDANT");
const u8 gEasyChatWord_Happening[] = _("ÉVÉNEMENT");
const u8 gEasyChatWord_HipAnd[] = _("HANCHE ET");
const u8 gEasyChatWord_Shake[] = _("SECOUER");
const u8 gEasyChatWord_Shady[] = _("OMBRAGÉ");
const u8 gEasyChatWord_Upbeat[] = _("OPTIMISTE");
const u8 gEasyChatWord_Modern[] = _("MODERNE");
const u8 gEasyChatWord_SmellYa[] = _("JE SUIS AUDACIEUX");
const u8 gEasyChatWord_Bang[] = _("CLAQUER");
const u8 gEasyChatWord_Knockout[] = _("ASSOMMER");
const u8 gEasyChatWord_Hassle[] = _("TRACAS");
const u8 gEasyChatWord_Winner[] = _("GAGNANT");
const u8 gEasyChatWord_Fever[] = _("FIÈVRE");
const u8 gEasyChatWord_Wannabe[] = _("WANNABE");
const u8 gEasyChatWord_Baby[] = _("BÉBÉ");
const u8 gEasyChatWord_Heart[] = _("CŒUR");
const u8 gEasyChatWord_Old[] = _("VIEUX");
const u8 gEasyChatWord_Young[] = _("JEUNE");
const u8 gEasyChatWord_Ugly[] = _("LAID");
