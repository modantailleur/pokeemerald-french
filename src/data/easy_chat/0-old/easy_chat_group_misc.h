const u8 gEasyChatWord_Highs[] = _("DES HAUTS");
const u8 gEasyChatWord_Lows[] = _("FAIBLES");
const u8 gEasyChatWord_Um[] = _("UN");
const u8 gEasyChatWord_Rear[] = _("ARRIÈRE");
const u8 gEasyChatWord_Things[] = _("DES CHOSES");
const u8 gEasyChatWord_Thing[] = _("CHOSE");
const u8 gEasyChatWord_Below[] = _("CI-DESSOUS");
const u8 gEasyChatWord_Above[] = _("AU-DESSUS DE");
const u8 gEasyChatWord_Back[] = _("DOS");
const u8 gEasyChatWord_High[] = _("HAUT");
const u8 gEasyChatWord_Here[] = _("ICI");
const u8 gEasyChatWord_Inside[] = _("À L'INTÉRIEUR");
const u8 gEasyChatWord_Outside[] = _("DEHORS");
const u8 gEasyChatWord_Beside[] = _("À CÔTÉ DE");
const u8 gEasyChatWord_ThisIsItExcl[] = _("ÇA Y EST!");
const u8 gEasyChatWord_This[] = _("CE");
const u8 gEasyChatWord_Every[] = _("CHAQUE");
const u8 gEasyChatWord_These[] = _("CES");
const u8 gEasyChatWord_TheseWere[] = _("C'ÉTAIENT");
const u8 gEasyChatWord_Down[] = _("VERS LE BAS");
const u8 gEasyChatWord_That[] = _("QUE");
const u8 gEasyChatWord_ThoseAre[] = _("CE SONT");
const u8 gEasyChatWord_ThoseWere[] = _("CEUX-LÀ ÉTAIENT");
const u8 gEasyChatWord_ThatsItExcl[] = _("C'EST ÇA!");
const u8 gEasyChatWord_Am[] = _("SUIS");
const u8 gEasyChatWord_ThatWas[] = _("C'ÉTAIT");
const u8 gEasyChatWord_Front[] = _("DEVANT");
const u8 gEasyChatWord_Up[] = _("EN HAUT");
const u8 gEasyChatWord_Choice[] = _("CHOIX");
const u8 gEasyChatWord_Far[] = _("LOIN");
const u8 gEasyChatWord_Away[] = _("LOIN");
