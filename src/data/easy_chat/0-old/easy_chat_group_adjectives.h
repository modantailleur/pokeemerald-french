...
const u8 gEasyChatWord_Rickety[] = _("RACHITIQUE");
const u8 gEasyChatWord_RockSolid[] = _("SOLIDE COMME LE ROC");
const u8 gEasyChatWord_Hungry[] = _("AFFAMÉ");
const u8 gEasyChatWord_Tight[] = _("SERRÉ");
const u8 gEasyChatWord_Ticklish[] = _("CHATOUILLEUX");
const u8 gEasyChatWord_Twirling[] = _("TOURNOIR");
const u8 gEasyChatWord_Spiraling[] = _("SPIRALE");
const u8 gEasyChatWord_Thirsty[] = _("SOIF");
const u8 gEasyChatWord_Lolling[] = _("LOLLER");
const u8 gEasyChatWord_Silky[] = _("SOYEUX");
const u8 gEasyChatWord_Sadly[] = _("MALHEUREUSEMENT");
const u8 gEasyChatWord_Hopeless[] = _("DÉSESPÉRÉ");
const u8 gEasyChatWord_Useless[] = _("INUTILE");
const u8 gEasyChatWord_Drooling[] = _("BAVE");
const u8 gEasyChatWord_Exciting[] = _("PASSIONNANT");
const u8 gEasyChatWord_Thick[] = _("ÉPAIS");
const u8 gEasyChatWord_Smooth[] = _("LISSE");
const u8 gEasyChatWord_Slimy[] = _("VISQUEUX");
const u8 gEasyChatWord_Thin[] = _("MINCE");
const u8 gEasyChatWord_Break[] = _("CASSER");
const u8 gEasyChatWord_Voracious[] = _("VORACE");
const u8 gEasyChatWord_Scatter[] = _("DISPERSION");
const u8 gEasyChatWord_Awesome[] = _("GÉNIAL");
const u8 gEasyChatWord_Wimpy[] = _("WIMPY");
const u8 gEasyChatWord_Wobbly[] = _("BANCAL");
const u8 gEasyChatWord_Shaky[] = _("PRÉCAIRE");
const u8 gEasyChatWord_Ripped[] = _("DÉCHIRÉ");
const u8 gEasyChatWord_Shredded[] = _("RÂPÉ");
const u8 gEasyChatWord_Increasing[] = _("EN AUGMENTANT");
const u8 gEasyChatWord_Yet[] = _("ENCORE");
const u8 gEasyChatWord_Destroyed[] = _("DÉTRUIT");
const u8 gEasyChatWord_Fiery[] = _("ARDENT");
