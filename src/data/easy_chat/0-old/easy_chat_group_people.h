...
const u8 gEasyChatWord_Babe[] = _("BÉBÉ");
const u8 gEasyChatWord_Family[] = _("FAMILLE");
const u8 gEasyChatWord_Her[] = _("SON");
const u8 gEasyChatWord_Him[] = _("LUI");
const u8 gEasyChatWord_He[] = _("IL");
const u8 gEasyChatWord_Place[] = _("LIEU");
...
const u8 gEasyChatWord_ToThem[] = _("POUR EUX");
...
const u8 gEasyChatWord_Been[] = _("A ÉTÉ");
